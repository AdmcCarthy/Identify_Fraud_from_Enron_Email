...
def param_optimize_gb_pipe(features, labels, grid_search=True, folds=2):
    """
    Hyper parameter optimization
    through parameter grid search
    during cross validation.

    Tailored for a Gradient Boosting classifer.
    Stored as a pipeline and including,
    feature selction and PCA decomposition.
    ...
    lrclf = ensemble.GradientBoostingClassifier()
